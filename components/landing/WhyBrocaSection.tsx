...
const benefits = [
  "Save 10+ hours per week on client onboarding",
  "Onboard clients 40% faster with AI automation",
  "Never miss a document or deadline again",
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-fade-up">
            <div className="glass-card p-10 relative overflow-hidden">
              ...
              <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground mb-6 leading-tight">
                ...
                <span className="text-primary">top brokers</span> wish they had years ago
              </h3>

              <p className="text-muted-foreground leading-relaxed mb-8">
                BROCA doesn't just save time—it elevates your entire practice. From first contact to complete onboarding, you'll have an intelligent partner handling document extraction and client intake while you focus on relationships and revenue.
              </p>
          ...
          <div className="space-y-8 animate-fade-up stagger-2">
            ...
            <div className="inline-flex items-center gap-2 bg-secondary border border-border rounded-full px-4 py-2">
              <span className="text-sm font-medium text-foreground">WHY BROKERS CHOOSE BROCA</span>
            </div>

            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground">
              Why Brokers Love BROCA
            </h2>

            <p className="text-muted-foreground text-lg max-w-lg">
              Join thousands of professionals in real estate, insurance, and mortgage who've transformed their client onboarding with intelligent automation.
            </p>
