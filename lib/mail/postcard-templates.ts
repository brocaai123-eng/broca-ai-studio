...
<body style="margin:0;padding:0;width:4.25in;height:6.25in;font-family:Georgia,serif;background:linear-gradient(160deg,#064e3b 0%,#059669 55%,#a7f3d0 100%);color:#fff;">
  <div style="padding:0.45in 0.4in;">
    <p style="margin:0;font-size:11pt;letter-spacing:0.12em;text-transform:uppercase;opacity:0.9;">BrocaAI</p>
...
<body style="margin:0;padding:0;width:4.25in;height:6.25in;font-family:Georgia,serif;background:#f8fafc;color:#0f172a;">
  <div style="padding:0.4in;width:2.1in;">
    ...
    <p style="margin:0 0 0.2in;font-size:11pt;line-height:1.45;">BrocaAI helps healthcare practices reach the right partners. Reply to learn more about tailored outreach.</p>
    <p style="margin:0;font-size:10pt;line-height:1.4;color:#334155;">BrocaAI<br/>12794 Forest Hill Blvd, Suite 29<br/>Wellington, FL 33414</p>
  </div>
...
<body style="margin:0;padding:0;width:4.25in;height:6.25in;font-family:Helvetica,Arial,sans-serif;background:#0f172a;color:#f8fafc;">
  <div style="padding:0.45in;">
    ...
    <p style="margin:0;font-size:12pt;line-height:1.5;color:#cbd5e1;">Modern tools to strengthen your referral network and practice growth — from BrocaAI.</p>
  </div>
</body></html>`,
    back_html: `<html><head><meta charset="utf-8"/></head>
<body style="margin:0;padding:0;width:4.25in;height:6.25in;font-family:Helvetica,Arial,sans-serif;background:#ffffff;color:#0f172a;">
  <div style="padding:0.4in;width:2.1in;">
    ...
    <p style="margin:0;font-size:10pt;color:#475569;">BrocaAI · Wellington, FL</p>
  </div>
</body></html>`,
  },
  {
...
<body style="margin:0;padding:0;width:6.25in;height:9.25in;font-family:Georgia,serif;background:#fff7ed;color:#1c1917;">
  ...
  <div style="padding:0.55in 0.55in 0.4in;">
    <p style="margin:0;font-size:12pt;letter-spacing:0.1em;text-transform:uppercase;color:#9a3412;">BrocaAI</p>
...
<body style="margin:0;padding:0;width:6.25in;height:9.25in;font-family:Georgia,serif;background:#ffffff;color:#1c1917;">
  <div style="padding:0.5in;width:3.2in;">
    ...
    <p style="margin:0 0 0.25in;font-size:12pt;line-height:1.5;">Thank you for the work you do. BrocaAI would like to share opportunities that may benefit your practice.</p>
    <p style="margin:0;font-size:11pt;line-height:1.45;color:#57534e;">BrocaAI<br/>12794 Forest Hill Blvd, Suite 29<br/>Wellington, FL 33414</p>
  </div>
</body></html>`,
  },
];
