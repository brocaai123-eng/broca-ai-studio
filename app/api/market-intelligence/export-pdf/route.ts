...
<body>
  ...
  <div class="footer">
    ...
    <div class="data-sources">
      <span class="source-badge ${data.dataSourceStatus.rentCast ? 'source-active' : 'source-inactive'}">Pricing Data ${data.dataSourceStatus.rentCast ? '✓' : '✗'}</span>
      <span class="source-badge ${data.dataSourceStatus.fred ? 'source-active' : 'source-inactive'}">Mortgage Rates ${data.dataSourceStatus.fred ? '✓' : '✗'}</span>
      <span class="source-badge ${data.dataSourceStatus.census ? 'source-active' : 'source-inactive'}">Demographics ${data.dataSourceStatus.census ? '✓' : '✗'}</span>
      <span class="source-badge ${data.dataSourceStatus.bls ? 'source-active' : 'source-inactive'}">Inflation ${data.dataSourceStatus.bls ? '✓' : '✗'}</span>
    </div>
